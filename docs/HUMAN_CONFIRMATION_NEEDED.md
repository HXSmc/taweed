...
| 1b | 🆕 🧑‍💻 **Self-serve, do TODAY, no email needed:** enroll in NPHIES Academy **"System Vendors Onboarding Course"** ([v-academy course 11](https://v-academy.nphies.sa/courses/11/system-vendors-onboarding-course?lang=en)) + **"Registering in nphies Platform"** ([course 6](https://academy.nphies.sa/courses/6/registering-in-nphies-platform?lang=en)) — the gated course material likely answers most of B1/B2 before anyone replies to your email | **NPHIES Academy (self-enrollment)** | B1, B2 |
| 2 | Ask PKI issuance + sandbox/conformance steps + KSA-office rule (**B3 direct-vs-clearinghouse RESOLVED: direct permitted; clearinghouse does NOT clearly remove B1/B2**) → **Email 2** | **NPHIES onboarding — `onboarding@chi.gov.sa`** (☎ 920033808; CC `support@nphies.sa`) | B1, B2 |
| 3 | Get clearinghouse quote **+ ask if it offloads your PKI/conformance or you still vendor-certify** → **Email 3** | **Waseel — `bdr@waseel.com`** (☎ 9200 120 99) | B3 ✅, D1 |
