  ...
  <DialogPrimitive.Portal>
    ...
    >
      <div className="flex items-center justify-between border-b border-hairline px-5 py-3">
        ...
        <DialogPrimitive.Close className="rounded-md p-1 text-muted hover:bg-surface-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent">
          <X className="size-4" />
