...
// (hard constrained decoding degrades Arabic fluency — VERIFIED H, plan §4.2).
// Terminology consistency is a documented Arabic-LLM risk; this pins the
// vocabulary a reviewer expects.
//
